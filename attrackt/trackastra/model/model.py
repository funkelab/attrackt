...
class EncoderLayer(nn.Module):
    def __init__(
        ...
        cutoff_spatial: int,
        window: int,
        positional_bias: Literal["bias", "rope", "none"],
        positional_bias_n_spatial: int,
    ):
        super().__init__()
...
class TrackingTransformer(torch.nn.Module):
    def __init__(
        ...
        dropout: float,
        pos_embed_per_dim: int,
        feat_embed_per_dim: int,
        window: int,
        spatial_pos_cutoff: int,
        attn_positional_bias: Literal["bias", "rope", "none"],
        attn_positional_bias_n_spatial: int,
        causal_norm: Literal["none", "linear", "softmax", "quiet_softmax"],
    ):
        super().__init__()
